...
const en: Dictionary = {
  ...
  "minigames.blockdle.blurb":
    "Guess today's Scrap Mechanic block from its stats. Six tries, color-coded hints.",
...
const ru: Dictionary = {
  ...
  "minigames.blockdle.blurb":
    "Угадайте сегодняшний блок Scrap Mechanic по характеристикам. Шесть попыток, цветные подсказки.",
  "minigames.blockdle.subtitle":
...
const de: Dictionary = {
  ...
  "minigames.blockdle.name": "Blockdle",
  "minigames.blockdle.blurb":
    "Errate den heutigen Scrap-Mechanic-Block anhand seiner Werte. Sechs Versuche, farbkodierte Hinweise.",
  "minigames.blockdle.subtitle":
...
const pl: Dictionary = {
  ...
  "minigames.blockdle.name": "Blockdle",
  "minigames.blockdle.blurb":
    "Zgadnij dzisiejszy klocek ze Scrap Mechanic po jego statystykach. Sześć prób, podpowiedzi oznaczone kolorami.",
  "minigames.blockdle.subtitle":
